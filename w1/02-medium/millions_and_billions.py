...
days_per_million_seconds = 10 ** 6 / seconds_per_minute / minutes_per_hour / hours_per_day
print(f"There are {round(days_per_million_seconds)} days in one million seconds.")
...
years_per_billion_seconds = 10 ** 9 / seconds_per_minute / minutes_per_day / days_per_year
print(f"There are {round(years_per_billion_seconds)} years per billion seconds")